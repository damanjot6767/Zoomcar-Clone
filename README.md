...
I have used  HTmL,CSS, Advance JavaScript, ReactJS, useReducer, Chakra UI etc. I also used tools like GitHub, Vercel as for deployment.
...
I have faced few challenges while working on project I dealt with them , sometime it take lots of time but I got some learning from that. some of the challenges are-<br>

location for pick up and drop drag and drop from google map. <br>
Integration backend to frontend as I was using Ejs, strugled little bit during integration.<br> 
