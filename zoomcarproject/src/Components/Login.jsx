...
if(!error){
  ...
  return (
    ...
    <Box color="#32CD32"fontSize="25px"fontWeight="bold" mb="10px" v>WELCOME TO LOGIN PAGE</Box>
    <Box  w="33%" m="auto" mt="30px" h="auto" bg="white" p="10px 0px"   border="2px" borderColor="green" borderRadius="20px">
