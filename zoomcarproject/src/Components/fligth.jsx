    ...
    return (
          <Box w={{base:"60%",md:"75%",lg:"90%"}} m="auto" style={{marginTop:"76px"}} fontFamily="'Arial Bold', sans-serif" >
            ...
            <SimpleGrid p="30px 0px"  columns={{base:1,md:2,lg:3}} gap={{base:5,md:7,lg:10}} >
             {data.map(({image,source,destination,price,departure,arrival,duration})=><Box border="3px solid" borderColor="black" borderRadius="20px" _hover={{borderColor:"green",transition:"0.6s",transform: "scale(1.1)",bg:"#F0FFFF"}}>
                <Image height="50%" borderTopRadius="20px" src={image} alt={price}/>
                <Box p="10px 10px"  borderBottomRadius="20px">
